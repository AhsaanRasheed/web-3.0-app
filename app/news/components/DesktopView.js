          ...
          <div className={style.topRow}>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              <NewsDropdown
                ...
                startPosition={"right"}
              />
              <div style={{ width: "22px", height: "1px" }}></div>
              <NewsDropdown
                label={"Articles per page:"}
                options={[
                  { lbl: 25, value: 25, disable: false },
                  { lbl: 50, value: 50, disable: false },
                  { lbl: 100, value: 100, disable: false },
                ]}
                onChange={(e) => setItemPerPage(e)}
                selectedOtp={itemPerPage}
                customWidth={"80px"}
              />
              <div style={{ width: "22px", height: "1px" }}></div>
            </div>
