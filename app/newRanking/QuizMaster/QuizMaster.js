...
import NewsDropdown from "@/app/news/components/dropdown";
import moment from "moment";

export default function QuizMaster({ PageHasBeenScroll }) {
  ...
  const getInitialValues = async (pageIndexX, itemPerPageX, weekly = true) => {
    toggleLoader(true);
    try {
      var firstday = weekly
      ...
      var lastday = weekly
        ...
        : "";
      let va = await get_ranking_QuizMaster(
        pageIndexX,
        itemPerPageX,
        firstday,
        lastday
    ...
    <>
      <div className={style.ConDiv}>
        ...
        {pageIndex == 1 && (
          <div
            className={`${style.topRankerCon} ${
              PageHasBeenScroll && style.topFlowAniamtion
            }`}
          >
            <div className={`${style.topperCon} ${style.Silver}`}>
              <div className={style.topRow}>
              ...
              <div className={style.BtmRow}>
                ...
                <div className={style.colValue}>
                  <label className={style.value}>{rankSec.quiz_played}</label>
                  <label className={style.title}>Quizzes</label>
                </div>

                <div className={style.colValue}>
                  <label className={style.value}>{rankSec.total_xp}</label>
                  <label className={style.title}>Total XP</label>
                </div>
              </div>
            </div>
            <div className={`${style.topperCon} ${style.Gold}`}>
              ...
              <div className={style.BtmRow}>
                <TopCoverPositionHolder />
                <div className={style.colValue}>
                  <label className={style.value}>{rankFirst.quiz_played}</label>
                  <label className={style.title}>Quizzes</label>
                </div>

                <div className={style.colValue}>
                  <label className={style.value}>{rankFirst.total_xp}</label>
                  <label className={style.title}>Total XP</label>
                </div>
              </div>
            </div>
            <div className={`${style.topperCon} ${style.Brown}`}>
              ...
              <div className={style.BtmRow}>
                <TopCoverPositionHolder />
                <div className={style.colValue}>
                  <label className={style.value}>{rankThird.quiz_played}</label>
                  <label className={style.title}>Quizzes</label>
                </div>

                <div className={style.colValue}>
                  <label className={style.value}>{rankThird.total_xp}</label>
                  <label className={style.title}>Total XP</label>
                </div>
              </div>
            </div>
        ...
        <div className={style.topDropDownBar}>
          {/* <InputTxtNew  value={searchTrader}
            onChange={(e) => {
              setSearchTrader(e);
            }}
            onSearch={() => {}} /> */}
          <NewsDropdown
            ...
            customWidth={"170px"}
            options={[
              { lbl: "All", value: false, disable: false },
              { lbl: "Weekly", value: true, disable: false },
            ]}
            onChange={(e) => {
              setWeeklyCheck(e);
              getInitialValues(pageIndex, itemPerPage, e.value);
            }}
            selectedOtp={weeklyCheck}
            startPosition={"right"}
          />
          <div style={{ marginLeft: 10 }} className={"TblPageViewdropdown"}>
            ...
            <Select
              ...
              onChange={(value) => {
                ...
                getInitialValues(1, selected, weeklyCheck.value);
              }}
            />
          </div>
        </div>
          ...
          <div className="OurCustomTblContainer">
            ...
            >
              ...
              <Pagination
                ...
                onPageChange={(v) => {
                  setPageIndex(v);
                  getInitialValues(v, itemPerPage, weeklyCheck.value);
                }}
              />
            </div>
          </div>
    ...
    <div className={style.MobModalRowDetails} onClick={handleClick}>
      <div className={style.Modal} ref={modalRef}>
        ...
        <div className={style.btmRow}>
          ...
          <div className={style.right}>
            <label>{userInfo.quiz_played}</label>
          </div>
        </div>
        <div className={style.btmRow}>
          <div className={style.left}>
