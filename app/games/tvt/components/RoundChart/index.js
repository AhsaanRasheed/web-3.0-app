...
const RoundChart = ({
  ...
  const options = {
    ...
    plugins: {
      ...
      //     // Calculate positions of divider lines
      //     const xParts = 5; // Number of parts on x-axis
      //     const xPartWidth = xAxis.width / xParts;

      //     for (let i = 1; i <= xParts; i++) {
      //       const x = xAxis.left + i * xPartWidth;
      //       ctx.save();
      //       ctx.beginPath();
      //       ctx.moveTo(x, yStart);
      //       ctx.lineTo(x, yEnd);
      //       ctx.lineWidth = 1;
      //       ctx.strokeStyle = 'red'; // Color of divider line
      //       ctx.stroke();
      //       ctx.restore();
      //     }
      //   },
      ...
      annotation: {
        ...
        events: ['click'] // TODO: click is not working need to debug
      },
    },
    scales: {
      x: {
