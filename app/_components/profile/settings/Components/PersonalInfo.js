...
import "./test.css";
const PersonalInfo = ({ prevResp, refresh, setRefresh }) => {
  ...
  function isValidString() {
    ...
    if (legalName.length >= 30 || !regex.test(legalName)) {
  ...
  useEffect(() => {
    if (legalNameError) setLegalNameError(false);
  }, [legalName]);
  useEffect(() => {
  ...
  const handleSave = async () => {
    ...
    isAllValid = isValidString() && isAllValid;
  ...
  const onCancel = () => {
    setLegalName(prevResp.first_name);
        ...
        <div className="">
          <div className="">
            <div className="">
                ...
                <div className="info-table-row-details">
                  <input
                    ...
                    style={{
                      ...
                      outline: 0,
                      borderBottom: editable ? "2px solid #134c7b" : 0,
                    }}
                    placeholder="-"
                    disabled={!editable}
                  />
                  {legalNameError && (
                    <p className="error-text" id="email-error">
                      Legal names must be under 30 characters and free of
                      special characters.
                    </p>
                  )}
                </div>
              ...
              <div className={`info-table-row ${styles.row}`}>
                <div className={`text-style-1 ${styles.text_head}`}>Email</div>
                <div className="info-table-row-details">
                  <input
                    value={email}
                  ...
                  {emailError && (
                    <p className="error-text" id="email-error">
                      E-mail address should be correct
                    </p>
                  )}
                </div>
              </div>
              <div className={`info-table-row ${styles.row}`}>
                ...
                <div className="info-table-row-details">
                  {editable ? (
                    <div className="autocomplete-wrapper">
                      {/* <Autocomplete
                        ...
                        onChange={(event, val) => setCountry(val)}
                  ...
                  {countryError && (
                    <p className="error-text" id="email-error">
                      The country selected is not valid. Please choose from the
                      provided list.
                    </p>
                  )}
                  {/*  */}
...
function renderCountryTitle(state, val) {
  return (
    state.name.toLowerCase().indexOf(val.toLowerCase()) !== -1 ||
    state.code.toLowerCase().indexOf(val.toLowerCase()) !== -1
  );
}
